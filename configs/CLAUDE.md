...
## Model routing (September 2026)

- Default: Fable 5.1 judges and Opus 5 executes, so specs, design, review, and diagnosis go to Fable 5.1, while settled specs and wide mechanical changes go to Opus 5.
...
- Escalation: when you stall twice on the same problem, prefer Codex GPT-6 Astra, since Fable 5.1 and Opus 5 share a lineage and only a different family reliably breaks the anchored hypothesis; if the Codex quota is gone, fall back to the other Claude model and say the cross-family check was skipped.
