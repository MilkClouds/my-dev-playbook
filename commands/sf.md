---
description: Simplify-and-fix the current diff (restores the pre-2.1.147 /simplify behavior)
argument-hint: "[additional focus]"
allowed-tools: Bash(git diff:*), Bash(git status:*), Bash(git log:*), Bash(git rev-parse:*), Bash(git ls-files:*), Bash(git show:*), Read, Edit, Write, Grep, Glob, Task
---
